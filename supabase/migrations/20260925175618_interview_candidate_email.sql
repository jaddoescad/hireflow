...
declare item uuid:=(payload->>'id')::uuid; c public.hf_candidates; new_email text:=lower(btrim(payload->>'candidate_email')); old public.hf_interviews; organizer_address text; invited jsonb; ids uuid[];
